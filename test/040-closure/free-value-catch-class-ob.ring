...
fn return_closure() -> (FuncType1) {
	...
	return fn() {
		...
		level0_local_int64_value_0++;
		level0_local_double_value_0++;
		level0_local_string_value_0 = level0_local_string_value_0 + @string(len(level0_local_string_value_0));
		...
		level0_local_job_value_0.String = level0_local_job_value_0.String + @string(len(level0_local_job_value_0.String));
