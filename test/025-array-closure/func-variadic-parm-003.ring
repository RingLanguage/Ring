...
fn func_variadic_parameter_dimension_1(FuncType... array_value) {
    ...
    for _, local_func_value_0 = range array_value {
        local_func_value_0();
    }
}
...
fn func_variadic_parameter_dimension_2(FuncType[]... array_value) {
    ...
    var FuncType local_func_value_0;
    for _, array_tmp_1 = range array_value {
        for _, local_func_value_0 = range array_tmp_1 {
            local_func_value_0();
        }
    }
...
fn func_variadic_parameter_dimension_3(FuncType[!2]... array_value) {
    ...
    var FuncType[] array_tmp_1;
    var FuncType local_func_value_0;
    for _, array_tmp_2 = range array_value {
        for _, array_tmp_1 = range array_tmp_2 {
            for _, local_func_value_0 = range array_tmp_1 {
                local_func_value_0();
            }
        }
