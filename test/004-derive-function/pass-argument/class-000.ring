...
fn pass_1_job1(Job1 a) {
	fmt::println(a);
}

fn pass_2_job1(Job1 a, Job1 b) {
	fmt::println(a, b);
}

fn pass_3_job1(Job1 a, Job1 b, Job1 c) {
    fmt::println(a, b, c);
}

fn pass_4_job1(Job1 a, Job1 b, Job1 c, Job1 d) {
    fmt::println(a, b, c, d);
}

fn pass_5_job1(Job1 a, Job1 b, Job1 c, Job1 d, Job1 e) {
    fmt::println(a, b, c, d, e);
}

fn pass_6_job1(Job1 a, Job1 b, Job1 c, Job1 d, Job1 e, Job1 f) {
    fmt::println(a, b, c, d, e, f);
}

fn pass_7_job1(Job1 a, Job1 b, Job1 c, Job1 d, Job1 e, Job1 f, Job1 g) {
    fmt::println(a, b, c, d, e, f, g);
}

fn pass_8_job1(Job1 a, Job1 b, Job1 c, Job1 d, Job1 e, Job1 f, Job1 g, Job1 h) {
