...
fn pass_1_string_array(string[] a) {
	fmt::println(a);
}

fn pass_2_string_array(string[] a, string[] b) {
	fmt::println(a, b);
}

fn pass_3_string_array(string[] a, string[] b, string[] c) {
    fmt::println(a, b, c);
}

fn pass_4_string_array(string[] a, string[] b, string[] c, string[] d) {
    fmt::println(a, b, c, d);
}

fn pass_5_string_array(string[] a, string[] b, string[] c, string[] d, string[] e) {
    fmt::println(a, b, c, d, e);
}

fn pass_6_string_array(string[] a, string[] b, string[] c, string[] d, string[] e, string[] f) {
    fmt::println(a, b, c, d, e, f);
}

fn pass_7_string_array(string[] a, string[] b, string[] c, string[] d, string[] e, string[] f, string[] g) {
    fmt::println(a, b, c, d, e, f, g);
}

fn pass_8_string_array(string[] a, string[] b, string[] c, string[] d, string[] e, string[] f, string[] g, string[] h) {
