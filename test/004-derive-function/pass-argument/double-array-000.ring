...
fn pass_1_double_array(double[] a) {
	fmt::println(a);
}

fn pass_2_double_array(double[] a, double[] b) {
	fmt::println(a, b);
}

fn pass_3_double_array(double[] a, double[] b, double[] c) {
    fmt::println(a, b, c);
}

fn pass_4_double_array(double[] a, double[] b, double[] c, double[] d) {
    fmt::println(a, b, c, d);
}

fn pass_5_double_array(double[] a, double[] b, double[] c, double[] d, double[] e) {
    fmt::println(a, b, c, d, e);
}

fn pass_6_double_array(double[] a, double[] b, double[] c, double[] d, double[] e, double[] f) {
    fmt::println(a, b, c, d, e, f);
}

fn pass_7_double_array(double[] a, double[] b, double[] c, double[] d, double[] e, double[] f, double[] g) {
    fmt::println(a, b, c, d, e, f, g);
}

fn pass_8_double_array(double[] a, double[] b, double[] c, double[] d, double[] e, double[] f, double[] g, double[] h) {
