...
fn func_variadic_parameter(bool para_bool_value, int para_int_value, double para_double_value, string para_string_value, string... array_value) {
    ...
    for _, string_value = range array_value {
