...
TypeCastInstructionTable type_cast_instruction_table = {
    ...
    // int
    {{RING_BASIC_TYPE_INT, RING_BASIC_TYPE_BOOL}, {RVM_CODE_CAST_INT_2_BOOL}},
    ...
    // int64
    // {{RING_BASIC_TYPE_INT64, RING_BASIC_TYPE_BOOL}, {RVM_CODE_CAST_INT64_2_INT, RVM_CODE_CAST_INT_2_BOOL}},
    // {{RING_BASIC_TYPE_INT64, RING_BASIC_TYPE_INT}, {RVM_CODE_CAST_INT64_2_INT}},
